...
class AuditFormScreen extends StatefulWidget {
  ...
  AuditFormScreen(this.sheetID, this.lobData,this.sheetName,this.isOffline);
...
class AuditFormState extends State<AuditFormScreen> {
                            ...
                            children: [
                              ...
                              DropDownWidget(() {
                                selectAgencyBottomSheet(context);
                                  ...
                                  widget.lobData["type"] == "repo_yard"?"Yard":
                                  "Agency",
                                  selectedAgencyIndex == 9999
                                      ?widget.lobData["type"] == "repo_yard"?"Select yard":"Select agency"
                                      : filteredAgencyList[selectedAgencyIndex]
                                  ["name"]),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                            ...
                                                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewArtifactScreen(widget.sheetID,questionList[pos]["id"].toString(),questionList[pos]["qm_sheet_sub_parameter"][index]["id"].toString(),"1456")));
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>UploadArtifactScreen(widget.sheetID,questionList[pos]["id"].toString(),questionList[pos]["qm_sheet_sub_parameter"][index]["id"].toString(),"1456")));
  ...
  saveAnswerLocally() async {
    ...
    offlineAudits.add({
      ...
      "sheet_name":widget.sheetName,
      "sheet":widget.lobData,
      "audit_type":widget.lobData["type"],
    ...
    var data=preferences.getString("answer_list");
    if(data!=null)
    {
      List<dynamic> list2 = jsonDecode(data);
      list2.add(offlineAudits);
      ...
      {
        String json = jsonEncode(offlineAudits);
        await preferences.setString('answer_list',json);
      }



    Toast.show("Audit saved in offline",
        duration: Toast.lengthLong,
        gravity: Toast.bottom,
        backgroundColor: Colors.green);

    print(offlineAudits.toString());
  ...
  prepareData(String methodType) async {
    ...
    var requestModel = {
      "submission_data": {
        ...
        widget.lobData["type"] + "_id":
            agencyList[selectedAgencyIndex]["id"].toString(),
        "sheet_type": widget.lobData["type"],
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    SizedBox(width: 10),
                    Text("Select "+widget.lobData["type"]=="repo_yard"?"Yard":"Agency",
                        style: TextStyle(
                          fontSize: 17,
                          fontWeight: FontWeight.w700,
                          color: Colors.black,
  ...
  fetchManagerDataRecovery(String productID) async {
    ...
    if (widget.lobData["type"] == "repo_yard") {
      print("REPO DATA");
    ...
    if(widget.isOffline)
    {
      ...
      if(data!=null)
      {
        ...
        for(int i=0;i<questionList.length;i++)
        {
          ...
          j++)
          {
            dropdownSelectionList[i][j]=answerList["questions"][i]["subs"][j]["option"];
            weightList[i][j]=answerList["questions"][i]["subs"][j]["orignal_weight"];
            finalCal=finalCal+double.parse(weightList[i][j]);
            controllerList[i][j].text=answerList["questions"][i]["subs"][j]["remark"];
